...
text.addEventListener('keyup', probar);
...
var audio = new Audio('audio/satie.mp3');
audio.play();
audio.volume= 0.3;
...
document.getElementById('sonidoPlay').addEventListener('click', function(){
    
    audio.play()}
)


document.getElementById('sonidoStop').addEventListener('click', function(){
...
// FUNCION PARA MENSAJE VALID Y COLOR INPUT

  function probar(){
      
    if(text.value.length < 4 || text.value.length > 12 || text.value == ""){
        text.style.background="rgb(180, 83, 83)";
        document.getElementById('msj').classList.remove("mensaje-error-activo2");
        document.getElementById('msj').classList.add("mensaje-error-activo");} 

    else{
        text.style.background="seagreen";
        perilla = true;
        document.getElementById('msj').classList.remove("mensaje-error-activo");
        document.getElementById('msj').classList.add("mensaje-error-activo2");
    }  
}

    //  FUNCION PAR VALIDAR Y BORRAR POPUP
    ...
    function validar(){
        ...
        var mensajeinfo = document.createElement('h3');
        var contenido = document.createTextNode('Welcome, ' + text.value); 
        var esto = mensajeinfo.appendChild(contenido);
        contenedor.appendChild(esto);
...
function startGame(){
  ...
  function reset_images(){
    ...
    document.getElementById('p33').style.visibility = 'visible';
      ...
      number_mvs= 0;
      document.getElementById('moves').textContent = 'Moves: 0';
      document.getElementById('tab_grid').style.background = 'grey';
  }
            ...
            case 'p11' :
                        ...
                        if(check_win()){
                         setTimeout(function() {
                                   ...
                                   document.getElementById('moves').innerHTML= "Congratulations, "+ text.value + " you did it in " + number_mvs + " moves";
